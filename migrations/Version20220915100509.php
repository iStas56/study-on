 ...
 */
final class Version20220915100509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, code VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, order_number INT DEFAULT NULL, PRIMARY KEY(id))');
